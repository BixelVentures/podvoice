...
ResamplerSpeaker = resampler_ns.class_("ResamplerSpeaker", cg.Component, speaker.Speaker)
...
def _validate_audio_compatibility(config):
    ...
    audio.final_validate_audio_schema(
        ...
        bits_per_sample=cv.UNDEFINED if passthrough else config.get(CONF_BITS_PER_SAMPLE),
